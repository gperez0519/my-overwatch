...
const responses = {
    // GREETING_PERSONALIZED: `Welcome ${nickName} to Hero Tavern! Please, have a seat and take a load off! Here's a round on the house!`,
    // GREETING_PERSONALIZED_II: `<prosody volume="x-loud">Hey you miscreants! You throw another chair and I'll toss you out myself!</prosody> Oh hey there ${nickName}! Welcome to Hero Tavern! You must be exhausted, drinks are <emphasis level="reduced">on</emphasis> me!`,
    // GREETING_PERSONALIZED_III: `<prosody volume="x-loud">Hey Jack! don't make me come back there!</prosody> Oh hey ${nickName}, sorry about that. Some people get a little <emphasis level="moderate">rowdy</emphasis> a round here. Welcome to Hero Tavern! You must be exhausted. Here, drinks are on me!`,
    GREETING_PERSONALIZED: `Junkrat, come on, you can't bury your treasure behind the bar. What is wrong with you? <audio src='https://my-overwatch.s3.amazonaws.com/Junkrat+-+Treasure.mp3'/> Uh, okay. Whatever, Oh hey there ${nickName}! Don't mind him, he can be a little weird sometimes. Welcome to Hero Tavern! You must be exhausted, drinks are <emphasis level="reduced">on</emphasis> me!`,
    GREETING_PERSONALIZED_II: `Bastion, can you do me a favor and bring me those boxes? <audio src='https://my-overwatch.s3.amazonaws.com/Bastion+-+Nanana.mp3'/> Wait, what? Bastion, I don't speak that language. Is anyone a translator in here? You know what, nevermind. ${nickName}, I'm so glad you are here. Welcome to Hero Tavern! I bet you could use a drink. I could as well.`,
    GREETING_PERSONALIZED_III: `<audio src='https://my-overwatch.s3.amazonaws.com/Genji+-+Ramen.mp3'/> Genji, we don't serve Ramen here, where did you get Ramen from? Actually, you know what, I don't want to know. Hey ${nickName}, Welcome to Hero Tavern! You must be exhausted, drinks are <emphasis level="reduced">on</emphasis> me!`,
    // GREETING_PERSONALIZED_DISPLAY: `Welcome ${nickName} to Hero Tavern! Please, have a seat and take a load off! Here's a round on the house!`,
    // GREETING_PERSONALIZED_II_DISPLAY: `Hey you miscreants! You throw another chair and I'll toss you out myself! Oh hey there ${nickName}! Welcome to Hero Tavern! You must be exhausted, drinks are on me!`,
    // GREETING_PERSONALIZED_III_DISPLAY: `Hey Jack! don't make me come back there! Oh hey ${nickName}, sorry about that. Some people get a little rowdy a round here. Welcome to Hero Tavern! You must be exhausted. Here, drinks are on me!`,
    GREETING_PERSONALIZED_DISPLAY: `Junkrat, come on, you can't bury your treasure behind the bar. What is wrong with you? Uh, okay. Whatever, Oh hey there ${nickName}! Don't mind him, he can be a little weird sometimes. Welcome to Hero Tavern! You must be exhausted, drinks are on me!`,
    GREETING_PERSONALIZED_II_DISPLAY: `Bastion, can you do me a favor and bring me those boxes? Wait, what? Bastion, I don't speak that language. Is anyone a translator in here? You know what, nevermind. ${nickName}, I'm so glad you are here. Welcome to Hero Tavern! I bet you could use a drink. I could as well.`,
    GREETING_PERSONALIZED_III_DISPLAY: `Genji, we don't serve Ramen here, where did you get Ramen from? Actually, you know what, I don't want to know. Hey ${nickName}, Welcome to Hero Tavern! You must be exhausted, drinks are on me!`,
    ...
    NEED_TO_LINK_MESSAGE: 'Before I can continue, you will need to link your battle.net account to the Hero Tavern skill using the card that I have sent to the Alexa app.',
    ...
    OVERWATCH_SERVICE_UNAVAILABLE: "Oh no! The Hero Tavern service is not available at the moment. Please try again later. If this continues to occur, send us an email at ultrium dev at gmail.com, that is <say-as interpret-as='spell-out'>ultriumdev@gmail.com</say-as>",
    ...
    OVERWATCH_SERVICE_UNAVAILABLE_DISPLAY: "Oh no! The Hero Tavern service is not available at the moment. Please try again later. If this continues to occur, send us an email at ultriumdev@gmail.com.",
    ...
    GOODBYE: `You are always welcome here ${nickName}! If you haven't already done so, please leave us a rating on the Hero Tavern - Overwatch skill in the skill store. I would appreciate it greatly. Stop by Hero Tavern next time and we can catch up again. Good luck in your battles!`,
