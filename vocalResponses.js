...
const responses = {
    GREETING: "Welcome to Blizzard Tavern! I can tell you your stats of your Overwatch progress. Say get my stats to hear your stats of your Overwatch profile.",
    ...
    GREETING_PERSONALIZED_V_DISPLAY: `Bastion, can you do me a favor and bring me those boxes? Wait, what? Bastion, I don't speak that language. Is anyone a translator in here? You know what, nevermind. ${nickName}, I'm so glad you are here. Welcome to Blizzard Tavern! I bet you could use a drink. I could as well.`,
    ...
    OVERWATCH_SERVICE_UNAVAILABLE: "Oh no! The Blizzard Tavern service is not available at the moment. Please try again later. If this continues to occur, send us an email at ultriumdev@gmail.com, that is <say-as interpret-as='spell-out'>ultriumdev@gmail.com</say-as>",
