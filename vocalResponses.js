...
const responses = {
    ...
    NEED_TO_LINK_MESSAGE: 'Before I can continue, you will need to link your battle.net account to the Blizzard Tavern - Overwatch skill using the card that I have sent to the Alexa app.',
    ...
    OVERWATCH_SERVICE_UNAVAILABLE: "Oh no! The Blizzard Tavern - Overwatch service is not available at the moment. Please try again later. If this continues to occur, send us an email at ultrium dev at gmail.com, that is <say-as interpret-as='spell-out'>ultriumdev@gmail.com</say-as>",
    ...
    OVERWATCH_SERVICE_UNAVAILABLE_DISPLAY: "Oh no! The Blizzard Tavern - Overwatch service is not available at the moment. Please try again later. If this continues to occur, send us an email at ultriumdev@gmail.com.",
